...
LABEL description="This is VTTP5 SSF day 12 lecture demo"
LABEL name="vttp5-ssf-day12l"
...
ENTRYPOINT ["java", "-jar", "target/vttp5_ssf_day12l-0.0.1-SNAPSHOT.jar","--server.port=${SERVER_PORT}"]
